...
server = function(input, output, session){
  ...
  output$kinderen <- renderValueBox({
    ...
    valueBox(
      value = tags$p(
        paste(formatC(100*Kinderen/TotaalMensen, digits = 2, format = "f", decimal.mark = ","),"%"),
        style = "font-size: 50%;"
      ),
  ...
  output$mensen <- renderValueBox({
    ...
    valueBox(
      value = tags$p(
        formatC(TotaalMensen, digits = 0, format = "f", big.mark = "."),
        style = "font-size: 50%;"
      ),
  ...
  output$uitkering <- renderValueBox({
    ...
    valueBox(
      value = tags$p(
        paste(formatC(100*uitkering/TotaalMensen, digits = 2, format = "f", decimal.mark = ","), "%"),
        style = "font-size: 50%;"
      ),
